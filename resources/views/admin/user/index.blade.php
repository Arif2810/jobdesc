          ...
          <table id="example1" class="table table-bordered table-hover">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{ $users->akses }}</td>
                <td>
                  <a href="user/{{$users->id}}/edit"><button class="btn btn-warning btn-sm">Edit</button></a>
                  @if( $users->id != Auth::id() )
                    <button class="btn btn-danger btn-sm" data-delid={{$users->id}} data-toggle="modal" data-target="#delete"><i class="glyphicon glyphicon-trash"></i> Hapus</button>
                  @endif
                </td>
              </tr>
              @endforeach
